 ...
 run: async (client, interaction, guildSettings) => {
  try {
   ...
   const embed = new EmbedBuilder() // Prettier
    .setTitle(`<:github:1265997148907110400> ${client.user.username} Github Repository`)
    .setDescription("**This project is open source here! [@TsukiyoDevs/Nyxia](https://github.com/TsukiyoDevs/Nyxia)**")
    .addFields([
     {
      name: `🔨 Latest commit`,
      value: `${time(lastTimestamp)} (${time(lastTimestamp, "R")})`,
     },
    ])
    .setFooter({
