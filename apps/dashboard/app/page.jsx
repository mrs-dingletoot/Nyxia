...
export default async function HomePage() {
 ...
 const userCount = await prismaClient.botData.findFirst({
   where :{
    ...
    <div className="mx-auto max-w-7xl pb-10 md:px-8 lg:px-16">
     ...
     <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 md:grid md:grid-cols-2 md:px-0 lg:grid-cols-3">
      <div className="bg-background-secondary row-span-1 overflow-hidden rounded-xl border border-neutral-800 p-4 duration-200 hover:bg-neutral-800/50">
       ...
       <div className="mt-3">
        <div className="flex flex-row items-center gap-1">
         ...
         <Image src={"https://cdn.discordapp.com/avatars/981755777754755122/6e66279659b3db0e56e249d9455a6967.webp?size=4096"} alt="User avatar" quality={95} width={20} height={20} className="h-5 min-h-5 w-5 min-w-5 self-baseline rounded-full" />
         <span className="text-xs">
          <span className="font-bold">dreamwxve</span> used <span className="text-accent-primary font-bold">/image blur</span>
         </span>
        </div>
      ...
      <div className="bg-background-secondary row-span-1 overflow-hidden rounded-xl border border-neutral-800 p-4 duration-200 hover:bg-neutral-800/50">
       ...
       <LevelUp avatar={"https://cdn.discordapp.com/avatars/981755777754755122/6e66279659b3db0e56e249d9455a6967.webp?size=4096"} username="dreamwxve" />
      </div>
